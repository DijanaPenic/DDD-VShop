...
namespace VShop.SharedKernel.Infrastructure
{
    ...
    public abstract class ResultBase<TSuccess> : OneOfBase<TSuccess, ApplicationError>, IResult
    {
        ...
        public static ApplicationError ValidationError(string message) => new ValidationError(message);
        public static ApplicationError InternalServerError(string message) => new InternalServerError(message);
        public static ApplicationError NotFoundError(string message) => new NotFoundError(message);
    }
